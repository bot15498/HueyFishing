...
namespace VoxelImporter
{
    public abstract class VoxelBaseExplosion : MonoBehaviour
    {
        ...
        public ColorSpace edit_colorSpace = ColorSpace.Uninitialized;
...
#if UNITY_EDITOR
        #region VersionUp
        public const int EditorDataVersion = 140;
        public int edit_dataVersion;
        ...
        {
            edit_dataVersion = EditorDataVersion;
        }
        #endregion
        #region Asset
