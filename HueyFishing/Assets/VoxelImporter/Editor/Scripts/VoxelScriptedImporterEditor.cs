...
namespace VoxelImporter
{
    ...
    public class VoxelScriptedImporterEditor : ScriptedImporterEditor
    {
        ...
        private SerializedProperty chunkPivotTProp;
...
#pragma warning restore 0414
        ...
        {
            new GUIContent("Combine (VoxelObject)"),
            new GUIContent("Individual (VoxelChunksObject)"),
            new GUIContent("Models (VoxelFrameAnimationObject)"),
        };
        private readonly int[] MeshModeValues =
        {
            ...
            (int)VoxelScriptedImporter.MeshMode.Models,
        };
        ...
        public override void OnEnable()
        {
            ...
            chunkPivotTProp = serializedObject.FindProperty("chunkPivotT");
        ...
        public override void OnInspectorGUI()
        {
            ...
            #region Settings
            {
                ...
                EditorGUI.indentLevel++;
                {
                    ...
                    if ((VoxelScriptedImporter.MeshMode)meshModeProp.intValue == VoxelScriptedImporter.MeshMode.Individual)
                    {
                        EditorGUILayout.PropertyField(chunkPivotTProp);
                    }
                }
                EditorGUI.indentLevel--;
            }
