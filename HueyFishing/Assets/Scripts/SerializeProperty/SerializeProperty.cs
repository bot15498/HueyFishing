// Source: https://discussions.unity.com/t/serialize-c-properties-how-to-with-code/683762
...
namespace SerializeProperty
{
    [AttributeUsage(AttributeTargets.Field)]
    public class Serialize : PropertyAttribute
    {
        public string PropertyName { get; private set; }

        public Serialize(string propertyName)
        {
...
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(Serialize))]
    public class SerializePropertyAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (_propertyFieldInfo == null)
                _propertyFieldInfo = target.GetType().GetProperty(((Serialize)attribute).PropertyName,
