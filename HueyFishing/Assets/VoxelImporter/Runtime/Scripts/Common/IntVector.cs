...
namespace VoxelImporter
{
    ...
    public struct ShortVector3
    {
        ...
        public static ShortVector3 operator -(ShortVector3 value1, ShortVector3 value2)
        {
            return new ShortVector3((short)(value1.x - value2.x), (short)(value1.y - value2.y), (short)(value1.z - value2.z));
        }
        public static ShortVector3 operator *(short scaleFactor, ShortVector3 value)
        {
            return new ShortVector3((short)(scaleFactor * value.x), (short)(scaleFactor * value.y), (short)(scaleFactor * value.z));
        }
        public static ShortVector3 operator *(ShortVector3 value, short scaleFactor)
        {
            return new ShortVector3((short)(value.x * scaleFactor), (short)(value.y * scaleFactor), (short)(value.z * scaleFactor));
        }
        public static ShortVector3 operator *(ShortVector3 value1, ShortVector3 value2)
        {
            return new ShortVector3((short)(value1.x * value2.x), (short)(value1.y * value2.y), (short)(value1.z * value2.z));
        }
        public static ShortVector3 operator /(ShortVector3 value, short divider)
        {
            return new ShortVector3((short)(value.x / divider), (short)(value.y / divider), (short)(value.z / divider));
        }
        public static ShortVector3 operator /(ShortVector3 value1, ShortVector3 value2)
        {
            return new ShortVector3((short)(value1.x / value2.x), (short)(value1.y / value2.y), (short)(value1.z / value2.z));
        ...
        public static bool operator ==(ShortVector3 value1, ShortVector3 value2)
        {
            return value1.x == value2.x && value1.y == value2.y && value1.z == value2.z;
        }
        public static bool operator !=(ShortVector3 value1, ShortVector3 value2)
        ...
        public static ShortVector3 Max(ShortVector3 value1, ShortVector3 value2)
        {
            return new ShortVector3(System.Math.Max(value1.x, value2.x), System.Math.Max(value1.y, value2.y), System.Math.Max(value1.z, value2.z));
        }
        public static ShortVector3 Min(ShortVector3 value1, ShortVector3 value2)
        {
            return new ShortVector3(System.Math.Min(value1.x, value2.x), System.Math.Min(value1.y, value2.y), System.Math.Min(value1.z, value2.z));
        }
        public static ShortVector3 zero { get { return new ShortVector3(0, 0, 0); } }
        public static ShortVector3 one { get { return new ShortVector3(1, 1, 1); } }
        public override int GetHashCode()
        {
            return x.GetHashCode() ^ y.GetHashCode() ^ z.GetHashCode();
        }
        public override bool Equals(System.Object obj)
        {
            if (!(obj is ShortVector3)) return false;
            ShortVector3 data = (ShortVector3)obj;
            return this == data;
        }
